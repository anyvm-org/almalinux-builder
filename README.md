...
[![Build](https://github.com/anyvm-org/almalinux-builder/actions/workflows/build.yml/badge.svg)](https://github.com/anyvm-org/almalinux-builder/actions/workflows/build.yml)

Latest: v2.0.0


The image builder for `almalinux`
...
2. Run the builder locally on your Ubuntu machine.
    ...
    ```bash
    python3 build.py conf/almalinux-9.conf
    ```
